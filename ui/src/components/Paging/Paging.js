...
export class Paging extends React.Component {
    ...
    render () {
        ...
        if (current > 1) {
            itemsList.push(
                <li key="-1" className="arrow">
                    <a href="#" onClick={ this._handlePageButtonClick.bind(this, current - 1) }>&laquo;</a>
                </li>
            );
        }
        for (let i = 0; i < totalPages; i++) {
            if (
                ...
                itemsList.push(
                    <li key={i} className={ cx({ 'current': current === i+1 }) }>
                        <a href="#" onClick={ this._handlePageButtonClick.bind(this, i + 1) }>{ i + 1 }</a>
                    </li>
                );
            } else if (
                ...
                itemsList.push(
                    <li key={i}>
                        <a href="#" onClick={ this._handlePageButtonClick.bind(this, i + 1) }>&hellip;</a>
                    </li>
                );
            }
        }
        if (current < totalPages) {
            itemsList.push(
                <li key="-2" className="arrow">
                    <a href="#" onClick={ this._handlePageButtonClick.bind(this, current + 1) }>&raquo;</a>
                </li>
            );
        }
        return (
